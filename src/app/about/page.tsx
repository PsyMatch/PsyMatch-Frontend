...
export default function AcercaDeNosotrosPage() {
    ...
    const equipoBackend = [
        ...
        },
        {
            ...
            apodo: 'Fran',
            rol: 'Backend Developer',
            descripcion: 'El corazón que late en el centro del equipo. Cuando el ánimo baja, él lo levanta. Su combinación de habilidades técnicas y carisma humano lo convierte en el mago de PsyMatch.',
