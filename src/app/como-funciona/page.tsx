        ...
        <div className="min-h-screen bg-gradient-to-br pt-14 from-blue-50 to-indigo-100">
            <div className="w-[50%] m-auto text-center items-center flex flex-col h-52 justify-between">
                <div>
                    ...
                    <span className="text-gray-700">Descubre cómo nuestra plataforma impulsada por inteligencia artificial te conecta con el terapeuta perfecto en solo unos minutos.</span>   
                </div>
