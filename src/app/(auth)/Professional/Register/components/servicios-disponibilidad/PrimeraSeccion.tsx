...
return (
    <>
        ...
        {typeof errors.especialidades === "string" && touched.especialidades && (
            <p className="mt-1 ml-5 text-sm text-red-600">{errors.especialidades}</p>
        )}
        ...
        <span className="ml-5 font-bold">Enfoques terapéuticos* (Selecciona al menos 2)</span>
        {typeof errors.enfoques === "string" && touched.enfoques && (
            <p className="mt-1 ml-5 text-sm text-red-600">{errors.enfoques}</p>
        )}
        <div className="grid grid-cols-2 gap-3 px-5 mt-4 mb-20 text-sm text-start">
        ...
        <span className="ml-5 font-bold">Tipos de sesión ofrecidos</span>
        {typeof errors.tipos === "string" && touched.tipos && (
            <p className="mt-1 ml-5 text-sm text-red-600">{errors.tipos}</p>
        )}
        ...
        <span className="ml-5 font-bold">Modalidades de servicio</span>
        {typeof errors.modalidades === "string" && touched.modalidades && (
            <p className="mt-1 ml-5 text-sm text-red-600">{errors.modalidades}</p>
        )}
        <div className="grid grid-cols-3 gap-3 px-5 mt-4 text-sm text-start">
