        ...
        <div>
            ...
            <div className="flex flex-col items-center gap-6 mt-6 mb-10">
                <div className="flex flex-col items-center p-4 border-2 border-gray-500 border-dashed rounded-xl">
                    ...
                    ></input>
                    {typeof errors.matricula === 'string' && touched.matricula && <p className="text-sm text-red-600">{errors.matricula}</p>}
                </div>
                ...
                <div className="flex flex-col items-center p-4 border-2 border-gray-500 border-dashed rounded-xl">
                    ...
                    ></input>
                    {typeof errors.seguro === 'string' && touched.seguro && <p className="text-sm text-red-600">{errors.seguro}</p>}
                </div>
            </div>
        </div>
    );
