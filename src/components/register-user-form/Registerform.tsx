...
const RegisterSchema = Yup.object().shape({
  ...
  emergencyContact: Yup.string()
    ...
    .test(
      ...
      'El contacto de emergencia debe ser diferente al número de teléfono',
      function (value) {
    ...
    <div className="w-full max-w-sm space-y-4 sm:max-w-md sm:space-y-6">
      <div className="space-y-2 text-center">
        ...
        <p className="text-sm text-gray-600 sm:text-base">
          Únete a miles de usuarios que han encontrado a su terapeuta ideal
        </p>
      </div>
            ...
            <div className="md:grid md:grid-cols-2 md:gap-4">
             ...
             <CustomInput
              ...
              <div className="space-y-1">
                ...
                {errors.socialWork && touched.socialWork && (
