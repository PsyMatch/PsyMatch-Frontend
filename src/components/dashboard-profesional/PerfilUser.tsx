                    ...
                    <form className="space-y-6">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <Input className="border rounded px-3 py-2 w-full" value={user.fullName} disabled={!editable} />
                            </div>
                            <div>
                                <label className="block text-sm font-medium mb-1">Fecha de Nacimiento</label>
                                <input className="border rounded px-3 py-2 w-full" value={user.birthDate} disabled={!editable} />
                            </div>
                            <div>
                                <label className="block text-sm font-medium mb-1">Número de teléfono</label>
                                <Input className="border rounded px-3 py-2 w-full" value={user.phone} disabled={!editable} />
                            </div>
                            <div>
                                <label className="block text-sm font-medium mb-1">Correo electrónico</label>
                                <Input className="border rounded px-3 py-2 w-full" value={user.email} disabled={!editable} />
                            </div>
                            <div>
                                <label className="block text-sm font-medium mb-1">DNI</label>
                                <Input className="border rounded px-3 py-2 w-full" value={user.dni} disabled={!editable} />
                            </div>
                            <div>
                                <label className="block text-sm font-medium mb-1">Dirección</label>
                                <Input className="border rounded px-3 py-2 w-full" value={user.address} disabled={!editable} />
                            </div>
                            <div>
                                <label className="block text-sm font-medium mb-1">Obra Social</label>
                                <Input className="border rounded px-3 py-2 w-full" value={user.socialWork} disabled={!editable} />
                            </div>
                            <div>
                                <label className="block text-sm font-medium mb-1">Contacto de Emergencia</label>
                                <Input className="border rounded px-3 py-2 w-full" value={user.emergencyContact} disabled={!editable} />
                            </div>
                        </div>
                        {editable && (
