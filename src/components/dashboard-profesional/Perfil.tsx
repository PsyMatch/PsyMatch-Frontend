...
const Perfil = () => {
    ...
    original: ResponseDataProfile) => {
        ...
        let bodySend = Object.fromEntries(
                    ...
                    >
                        {({ values, handleChange, setFieldValue  }) => (
                            <Form className="space-y-6">
                                ...
                                <div className={`grid w-full grid-cols-2 col-span-2 gap-4 ${editable ? "md:grid-cols-1 gap-8" : "md:grid-cols-2"}`}>
                                        ...
                                        <div>
                                            ...
                                            <ul>
                                                ...
                                                {/* PONER INPUT */}
                                                {editable && <button type="button" className="px-5 text-xs text-white bg-violet-800" onClick={() => {setMenuEnfoques(!menuEnfoques)}}>Agregar Enfoque</button>}
                                                {menuEnfoques || editable && 
                                                <div>
                                                    <div className="text-sm text-gray-500 ">Manetene apretado ctrl para seleccionar múltiples</div>
                                                    ...
                                                    >
                                                        ...
                                                        <option value="emdr">Desensibilización y reprocesamiento por movimientos oculares</option>
                                        ...
                                        <div>
                                            ...
                                            <ul>
                                                ...
                                                {editable && <button type="button" className="px-5 text-xs text-white bg-violet-800" onClick={() => {setMenuEspecialidades(!menuEspecialidades)}}>Agregar Especialidades</button>}
                                        ...
                                        <div>
                                            ...
                                            {editable && <button type="button" className="px-5 text-xs text-white bg-violet-800" onClick={() => {setMenuIdiomas(!menuIdiomas)}}>Agregar Idioma</button>}
                                        ...
                                        <div>
                                            ...
                                            <div className="flex flex-row flex-wrap gap-2">
                                                {perfil?.insurance_accepted.map((insurance: string, index: number) => (
                                                    <span key={index} className="bg-white-400 px-4 py-[2px] text-sm font-bold rounded-xl">{insurance}</span>
                                                ))}
                                            </div>
                                            {/* PONER INPUT */}

                                             {editable && <button type="button" className="px-5 text-xs text-white bg-violet-800" onClick={() => {setMenuIsurances(!menuIsurances)}}>Agregar Obra Social</button>}
                                        ...
                                        <div>
                                            ...
                                            <div className="flex flex-row flex-wrap gap-2">
                                                {perfil?.session_types.map((tipo: string, index: number) => (
                                                    <span key={index} className="bg-white-400 px-4 py-[2px] text-sm font-bold rounded-xl">{tipo}</span>
                                                ))}
                                            </div>
                                            {/* PONER INPUT */}

                                            {editable && <button type="button" className="px-5 text-xs text-white bg-violet-800" onClick={() => {setMenuTipos(!menuTipos)}}>Agregar Tipo de Sesión</button>}
                                            {menuTipos || editable && 
                                                <div>
                                                    <div className="text-sm text-gray-500 ">Manetene apretado ctrl para seleccionar múltiples</div>
                                                    <select className="mt-4"
                                        ...
                                        <div>
                                            ...
                                            />
                                            {/* PONER INPUT */}
                                            {editable && <button type="button" className="px-5 text-xs text-white bg-violet-800" onClick={() => {setMenuModalidad(!menuModalidad)}}>Agregar Modalidad de Sesión</button>}
                                        ...
                                        <div>
                                            ...
                                            <div className="flex flex-row flex-wrap gap-2">
                                                {perfil?.availability.map((dia: string, index: number) => (
                                                    <span key={index} className="bg-white-400 px-4 py-[2px] text-sm font-bold rounded-xl">{dia}</span>
                                                ))}
                                            </div>
                                            {/* PONER INPUT */}
                                            {editable && <button type="button" className="px-5 text-xs text-white bg-violet-800" onClick={() => {setMenuAvailability(!menuAvailability)}}>Agregar Día</button>}
