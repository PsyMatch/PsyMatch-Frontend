...
export const validationSchema = Yup.object().shape({
  opcionesSeleccionadas: Yup.array()
    .min(3, "Selecciona al menos 3 especialidades")
    .required("Debes seleccionar especialidades"),

  opcionesEnfoqueSeleccionadas: Yup.array()
    .min(2, "Selecciona al menos 2 enfoques terapéuticos")
    .required("Debes seleccionar enfoques"),

  opcionesTipoSeleccionadas: Yup.array()
    .min(1, "Selecciona al menos un tipo de sesión")
    .required("Debes seleccionar tipos de sesión"),

  opcionesModalidadSeleccionadas: Yup.array()
    .min(1, "Selecciona al menos una modalidad")
    .required("Debes seleccionar modalidad"),

  fieldPareja: Yup.string().when('opcionesTipoSeleccionadas', (tipos: any, schema: any) => {
  ...
  fieldIndividual: Yup.string().when('opcionesTipoSeleccionadas', (tipos: any, schema: any) => {
  ...
  fieldFamiliar: Yup.string().when('opcionesTipoSeleccionadas', (tipos: any, schema: any) => {
  ...
  fieldGrupo: Yup.string().when('opcionesTipoSeleccionadas', (tipos: any, schema: any) => {
  ...
  opcionesDiasSeleccionadas: Yup.array()
    .min(1, "Selecciona al menos un día disponible")
    .required("Debes seleccionar días disponibles"),
